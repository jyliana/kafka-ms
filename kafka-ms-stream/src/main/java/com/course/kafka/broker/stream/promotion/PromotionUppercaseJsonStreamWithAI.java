...
public class PromotionUppercaseJsonStreamWithAI {
  ...
  void kstreamPromotionUppercase(StreamsBuilder builder) {
	...
	sourceStream.print(Printed.<String, PromotionMessage>toSysOut().withLabel("JSON AI Serde Original stream"));
	uppercaseStream.print(Printed.<String, PromotionMessage>toSysOut().withLabel("JSON AI Serde Uppercase stream"));
  }
